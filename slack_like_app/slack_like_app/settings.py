"""
Django settings for slack_like_app project.
...
APP_NAME = 'Workspace'   # Add

# Quick-start development settings - unsuitable for production
# See https://docs.djangoproject.com/en/2.2/howto/deployment/checklist/

# SECURITY WARNING: keep the secret key used in production secret!
SECRET_KEY = '%=2mw2ztkcu$-ex-&40frvfznu0=#c(j%7&v47iq5^%yil^ivw'
...
ROOT_URLCONF = 'slack_like_app.urls'
...
WSGI_APPLICATION = 'slack_like_app.wsgi.application'
...
try:
    ...
    print('When you want to use social login, please see slack_like_app/github_settings-dist.py')
